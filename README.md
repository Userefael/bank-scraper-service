...
| `FAST_ANSWER_MS` | לא | כמה זמן `/connect` ממתין להתחברות מנוהלת לפני שהוא מחזיר `session_id` וממשיך ברקע. ברירת מחדל 8000. |
...
ברקע באותו דפדפן. הסיבה פשוטה: התחברות לבנק אורכת יותר ממה ש-gateway טיפוסי מוכן להמתין,
