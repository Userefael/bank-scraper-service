...
| `DEBUG_LOGIN_PAGE` | לא | `true` מדפיס ללוג את מבנה הדף כשההתחברות נוחתת במקום לא מזוהה. שמות ותוויות בלבד, בלי ערכים. |
...
ו-`HAPOALIM_OTP_SUBMIT_SELECTOR`, ולראות מה באמת בדף על ידי הדלקת `DEBUG_LOGIN_PAGE`.
